...
const strings = {
    'pt-br': {
        ...
        kanbanRemoveDimensionAlertContent: 'Ao apagar essa dimensão você NÃO remove os dados. Se você criar uma nova dimensão cujo nome é o mesmo nome dessa dimensão que você está excluindo, os dados serão passados para essa nova dimensão, caso contrário os dados permanecerão ocultos.',
