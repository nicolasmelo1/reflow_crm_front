const planilha1 = {
    ...
    tabelas : {
        t1 : {
            ...
            {titulo:"Cliente 7", subtitulo:"Comercial 1", valor: "20000", foot:"Alta"}],[
                ...
                {titulo:"Cliente 10", subtitulo:"Comercial 3", valor: "2200", foot:"Média"}],[
                    ...
                    table:[["Comercial 1", "20000", "Alta", "20/08/2019","20/08/2019", "Proposta.pdf", "Cliente pediu bla lba bla bla bla", "Negociação", "Transporte"],
                    ["Comercial 1", "20000", "Alta", "20/08/2019","20/08/2019", "Proposta.pdf", "Cliente não pediu bla lba bla bla bla", "Negociação", "Transporte"],
                    ["Comercial 1", "20000", "Alta", "20/08/2019","20/08/2019", "resposta.pdf", "Cliente adiou ", "Negociação", "Transporte"],
                    ["Comercial 1", "20000", "Alta", "20/08/2019","20/08/2019", "Proposta.pdf", "Cliente pediu bla lba bla bla bla", "Negociação", "Transporte"],
                    ["Comercial 1", "20000", "Alta", "20/08/2019","20/08/2019", "Proposta.pdf", "Cliente pediu bla lba bla bla bla", "Negociação", "Transporte"],
                    ["Comercial 1", "20000", "Alta", "20/08/2019","20/08/2019", "Proposta.pdf", "Cliente pediu bla lba bla bla bla", "Negociação", "Transporte"],
                    ["Comercial 1", "20000", "Alta", "20/08/2019","20/08/2019", "Proposta.pdf", "Cliente pediu bla lba bla bla bla", "Negociação", "Transporte"],
                    ["Comercial 1", "20000", "Alta", "20/08/2019","20/08/2019", "Proposta.pdf", "Cliente pediu bla lba bla bla bla", "Negociação", "Transporte"],
        ...
        t2 : {
            ...
            tableheader: ["Nome Comercial","Valor", "Expectativa",	"Data de Atualização", "Data de Inclusão", "Anexo",	"Historico", "Status", "Produto"],
            table:[["Comercial 1", "20000", "Alta", "20/08/2019", "Proposta.pdf", "Cliente pediu bla lba bla bla bla", "Negociação", "Transporte"],
            ["Comercial 5", "20000", "Alta", "20/08/2019", "Proposta.pdf", "Cliente pediu bla lba bla bla bla", "Negociação", "Transporte"],
            ["Comercial 5", "20000", "Alta", "20/08/2019", "Proposta.pdf", "Cliente pediu bla lba bla bla bla", "Negociação", "Transporte"],
            ["Comercial 5", "20000", "Alta", "20/08/2019", "Proposta.pdf", "Cliente pediu bla lba bla bla bla", "Negociação", "Transporte"],
            ["Comercial 5", "20000", "Alta", "20/08/2019", "Proposta.pdf", "Cliente pediu bla lba bla bla bla", "Negociação", "Transporte"],
            ["Comercial 5", "20000", "Alta", "20/08/2019", "Proposta.pdf", "Cliente pediu bla lba bla bla bla", "Negociação", "Transporte"],
