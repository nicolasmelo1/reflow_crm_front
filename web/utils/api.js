 ...
 * }
 */
export const getAuthenticationTokenAndAppendToHeaders = (req, headers={}) => {
    let secretToken = ''
 ...
 */
export const rateLimitingGateway = () => {
 ...
 *  
 * @param {object} controller - The controller object that should implement each http method it accept as key.
 * 
 * @returns {function} - The function that should be used in your controllers.
 */
export const apiHandler = (controller) => {
    const checkRateLimiting = rateLimitingGateway()
    
    return async (req, res) => {
        const methodHandler = controller[req.method.toLowerCase()]
